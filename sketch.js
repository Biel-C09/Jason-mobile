...
function preload(){
  ...
  upImg = loadImage("upbutton.png");
  downImg = loadImage("downbutton.png");
  rightImg = loadImage("rightbutton.png");
  leftImg = loadImage("leftbutton.png");
...
function setup() {
 ...
 upButton = createSprite(135,550);
 upButton.addImage(upImg);
 upButton.scale = 1;
 upButton.setCollider("circle",0,0,50);

 downButton = createSprite(135,655);
 downButton.addImage(downImg);
 downButton.scale = 1;
 downButton.setCollider("circle",0,0,50);

 rightButton = createSprite(220,600);
 rightButton.addImage(rightImg);
 rightButton.scale = 1;
 rightButton.setCollider("circle",0,0,50);

 leftButton = createSprite(50,600);
 leftButton.addImage(leftImg);
 leftButton.scale = 1;
 leftButton.setCollider("circle",0,0,50);

 zButton = createSprite(1325,600);
 zButton.addImage(zImg);
 zButton.scale = 1;
 zButton.setCollider("circle",0,0,50);

 xButton = createSprite(1430,605);
 xButton.addImage(xImg);
 xButton.scale = 1.4;
 xButton.setCollider("circle",0,0,50);
